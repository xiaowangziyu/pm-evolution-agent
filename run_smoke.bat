...
REM ========================================================================
REM 冒烟测试启动脚本 (每日自动运行)
REM 功能: 1. 启动 Flask 服务器 (如未启动)  2. 运行冒烟测试  3. 保存报告
REM ========================================================================
...
set "REPORT_FILE=%~dp0reports\smoke_test_%date:/=-%_%time::=-%.txt"
set "REPORT_FILE=!REPORT_FILE: =0!"

REM 创建报告目录
if not exist "reports" mkdir reports

"%PYTHON_CMD%" run_smoke.py
...
if %TEST_EXIT_CODE%==0 (
    ...
    echo   ❌ 冒烟测试发现问题 (错误代码: %TEST_EXIT_CODE%)
    echo   请查看上方输出了解详情
)
echo ============================================================
echo.
...
echo %TEST_EXIT_CODE% > "reports\smoke_test_last_exit_code.txt"
